...
class Virustotal(enumratorBaseThreaded):
    ...
    def enumerate(self):
        while self.url != '':
            ...
            if 'error' in resp:
                self.print_(R + "[!] Error: Virustotal probably now is blocking our requests" + V)
                break
...
def ip_details():
    ...
    details=requests.get("https://www."+ip)
    print(details.headers)
    #print(details.headers["Set-Cookie"])
